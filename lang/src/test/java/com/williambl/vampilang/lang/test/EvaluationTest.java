...
public class EvaluationTest {
    ...
    public void correctlyEvaluatesSimpleProgram() {
        ...
        var resolved = Assertions.assertDoesNotThrow(() -> program.resolveTypes(new EvaluationContext.Spec()));
    ...
    public void correctlyEvaluatesProgramWithVariables() {
        ...
        var resolved = Assertions.assertDoesNotThrow(() -> program.resolveTypes(evaluationSpec));
